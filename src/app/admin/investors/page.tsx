    ...
    <>
            ...
            <Form {...addForm}>
              <form id="add-investor-form" onSubmit={addForm.handleSubmit(onAddSubmit)} className="space-y-4">
                ...
                <FormField control={addForm.control} name="name" render={({ field }) => (
                  <FormItem><FormLabel>Full Name</FormLabel><FormControl><Input placeholder="John Investor" {...field} /></FormControl><FormMessage /></FormItem>
                )}/>
      ...
      <Card>
        <CardHeader>
            ...
            <CardDescription>A list of all investor profiles.</CardDescription>
        </CardHeader>
        <CardContent>
          {investorsLoading && (
                  ...
                  <TableBody>
                      {investors.map((investor) => (
                          <TableRow key={investor.id}>
                              ...
                              <TableCell><Badge variant="secondary">{investor.role}</Badge></TableCell>
            ...
            <Form {...editForm}>
              <form id="edit-investor-form" onSubmit={editForm.handleSubmit(onEditSubmit)} className="space-y-4">
                <FormField control={editForm.control} name="uid" render={({ field }) => (
                  <FormItem><FormLabel>Investor ID (UID)</FormLabel><FormControl><Input {...field} disabled /></FormControl><FormMessage /></FormItem>
                )}/>
