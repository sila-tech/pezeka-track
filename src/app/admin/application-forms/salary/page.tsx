            ...
            <div className="text-xs mt-4">
                <p>I……………………………………………………………………………………………………………………………………..of post office Box…………………………………………………in the Republic of Kenya make oath and say as follows;</p>
                 <ol className="list-decimal list-inside space-y-1 mt-2">
                    ...
                    <li><p className="font-bold">B) Disclosure of information:</p>You agree that Pezeka Kenya Limited may disclose details relating to your &lt;credit facility&gt; account to any third-party including credit reference bureau, if the Lender’s opinion such as disclosure is necessary for the purpose of evaluating your credit worthiness or any transaction with or credit application made to the lender or any other lawful purpose.<br/>2) You agree with the Lender may disclose details relating to your &lt;credit facility&gt; account including details of your default in servicing financial obligations on your &lt;credit facility&gt; account to any third-party including credit reference bureau for the purpose of evaluating your credit worthiness for any other lawful purpose.</li>
