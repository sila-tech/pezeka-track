...
function FormLine({ label, className, lineClassName }: FormLineProps) {
  return (
                ...
                <div className="border border-black p-2 mt-4">
                    ...
                    <div className="grid grid-cols-2 gap-x-8">
                     ...
                     <div>
                        <p>Age brackets:</p>
                        <div className="flex space-x-2 mt-1">
                            <span className="w-6 h-6 border border-black"></span><span className="w-6 h-6 border border-black"></span><span className="w-6 h-6 border border-black"></span><span className="w-6 h-6 border border-black"></span><span className="w-6 h-6 border border-black"></span>
                        </div>
                    </div>
                </div>
            </div>
